...
from icnet.models.spatial_dropout import spatial_dropout
...
class ICNetBasic(chainer.Chain):
    """ICNet Basic for semantic segmentation."""
    def __init__(self, config, pretrained_model=None):
        super(ICNetBasic, self).__init__()
        n_class = None
        this_mod = sys.modules[__name__]
